...
public class MenuAsset implements Disposable, AssetErrorListener {
	public static final String TAG = com.philosfight.game.game.Assets.class.getName();
	...
	public void init(AssetManager assetMenuManager) {
		...
		assetMenuManager.load(Constants.TEXTURE_ATLAS_ARENA, TextureAtlas.class);
